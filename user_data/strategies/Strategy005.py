...
class Strategy005(IStrategy):
    ...
    buy_params = {'buy_fastd': 1, 'buy_fishRsiNorma': 5, 'buy_rsi': 26, 'buy_volumeAVG': 150}
    # Sell hyperspace params:
    sell_params = {'sell_fishRsiNorma': 30, 'sell_minusDI': 4, 'sell_rsi': 74, 'sell_trigger': 'rsi-macd-minusdi'}
